...
export default function InviteFriends() {
  const referralLink = "https://ziracle.com/ref/abc123";
    ...
    <div className="bg-[#EFEAF6] rounded-3xl p-5 md:p-8 w-full mx-auto">
      ...
      <div className="flex items-center gap-2 my-6">
        <div className="bg-white text-sm md:text-base rounded-lg px-3 py-2 w-[300px] md:max-w-[453px] flex-grow text-gray-500 font-mono">
          ziracle.com/ref/abc123
        </div>
        <button className="bg-[#6B42DA] text-sm md:text-base whitespace-normal cursor-pointer text-white h-10 rounded-full font-medium font-z-epilogue px-4 w-fit hover:bg-[#5a36b8]">
          Copy link
        </button>
      </div>
      ...
      <div className="flex gap-4">
        ...
        <button className="flex items-center gap-2 bg-[#6B42DA] text-white px-6 py-1 rounded-full font-medium font-z-epilogue hover:bg-[#5a36b8]">
          <div className="w-[30px] h-[30px] relative">
